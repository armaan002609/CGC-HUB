  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="mb-10 text-center lg:text-left">
        <h1 className="text-4xl font-display font-black text-brand tracking-tight mb-3">Welcome Back</h1>
        <p className="text-muted font-medium">Log in to access your dashboard, manage registrations, and track live events.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center pl-2 pr-4">
            ...
            <Link href="#" className="text-xs font-bold text-brand hover:opacity-80 transition-opacity">Forgot password?</Link>
          </div>
          <input 
            type="password" 
            placeholder="••••••••" 
      ...
      <p className="mt-10 text-center text-sm text-muted font-medium">
        ...
        <Link href="/signup" className="font-bold text-brand hover:opacity-80 transition-opacity">
          Sign up
        </Link>
      </p>
    </div>
